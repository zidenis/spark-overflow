...
//  , val resCorpusQA   : String = "hdfs://master:54310/user/hduser/stackoverflow/CorpusQA.parquet/resources/CorpusQA.parquet"    // Corpus of Q&A generated by processing SO posts
//  , val resStopwords  : String = "hdfs://master:54310/user/hduser/stackoverflow/stopwords.txt"       // Set of words to be ignored as tokens
  ...
  , var qtyLDATopics  : Int = 12 // number of LDA latent topics
  ...
  , val maxIterations : Int = 30 // number of LDA training iterations

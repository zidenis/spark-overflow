...
object LDAExample {
  ...
  case class Params(
    appName       : String = "LDA"
  , master        : String = "local[*]"  
  , resSOPosts    : String = "./resources/Posts-Spark-100.xml" // Stack Overflow's Posts Dataset
  , resCorpusQ    : String = "./resources/CorpusQ.parquet"     // Corpus of Questions generated by processing SO posts 
  , resCorpusA    : String = "./resources/CorpusA.parquet"     // Corpus of Answers generated by processing SO posts
  , resCorpusQA   : String = "./resources/CorpusQA.parquet"    // Corpus of Q&A generated by processing SO posts
  , resStopwords  : String = "./resources/stopwords.txt"       // Set of words to be ignored as tokens
//    resSOPosts    : String = "hdfs://master:54310/user/hduser/stackoverflow/Posts.xml" // Stack Overflow's Posts Dataset
//  , resCorpusQ    : String = "hdfs://master:54310/user/hduser/stackoverflow/CorpusQ.parquet"     // Corpus of Questions generated by processing SO posts 
//  , resCorpusA    : String = "hdfs://master:54310/user/hduser/stackoverflow/CorpusA.parquet"     // Corpus of Answers generated by processing SO posts
//  , resCorpusQA   : String = "hdfs://master:54310/user/hduser/stackoverflow/CorpusQA.parquet/resources/CorpusQA.parquet"    // Corpus of Q&A generated by processing SO posts
//  , resStopwords  : String = "hdfs://master:54310/user/hduser/stackoverflow/stopwords.txt"       // Set of words to be ignored as tokens
  , minTermLenght : Int = 3  // A term should have at least minTermLenght characters to be considered as token
  , qtyOfTopTerms : Int = 20 // how many top terms should be printed on output
  ...
  , alpha         : Int = -1 // LDA dirichlet prior probability placed on document-topic distribution. Choose a low alpha if your documents are made up of a few dominant topics 
  , beta          : Int = -1 // LDA dirichlet prior probability placed on topic-word distribution. Choose a low beta if your topics are made up of a few dominant words
  , maxIterations : Int = 30 // number of LDA training iterations
  , termsPerTopic : Int = 20 // how many terms per topic should be printed on output 
  , topDocPerTopic: Int = 20 // how many top documents per topic should be printed on output
  , prtTopTerms   : Boolean = true
  , prtTopDocsPerT: Boolean = true
  )
